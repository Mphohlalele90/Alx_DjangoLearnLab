...
urlpatterns = [
    ...
    # Keep the function-based views for compatibility
    ...
    # Use the existing view functions with URL parameters
    path('follow/<int:user_id>/', views.follow_user, name='follow-by-id'),
    path('unfollow/<int:user_id>/', views.unfollow_user, name='unfollow-by-id'),
]
